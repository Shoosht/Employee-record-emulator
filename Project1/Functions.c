...
int izbornik(const char* const imeDatoteke) {
	...
	case 4:
		...
		pocetnoUcitavanje(imeDatoteke);
		(ZAPO*)pretrazivanjeZapos(poljeZapos);
		break;
	...
	case 5:
		...
		pocetnoUcitavanje(imeDatoteke);
		(ZAPO*)pretrazivanjeZaposIme(poljeZapos);
		break;

	case 6:

		pocetnoUcitavanje(imeDatoteke);
		(ZAPO*)pretrazivanjeZaposPrezime(poljeZapos);
		break;
